...
<html>
    ...
    <body>
        ...
        <h1>Gráfico de tiempo</h1>
        <form id="form-param">
    	<div class="container">
    	    <div>
    	        <input type="text" class="parametro" placeholder="Dia" value="Lunes"><input type="time" class="valor" placeholder="Costo total">
            </div>
            <div>
    	        <input type="text" class="parametro" placeholder="Dia" value="Martes"><input type="time" class="valor" placeholder="Costo total">
            </div>
            <div>
    	        <input type="text" class="parametro" placeholder="Dia" value="Miercoles"><input type="time" class="valor" placeholder="Costo total">
            </div>
            <div>
    	        <input type="text" class="parametro" placeholder="Dia" value="Jueves"><input type="time" class="valor" placeholder="Costo total">
            </div>
            <div>
    	        <input type="text" class="parametro" placeholder="Dia" value="Viernes"><input type="time" class="valor" placeholder="Costo total">
            </div>
    	</div>
    	<div class="buttons">
    		<button type="button" class="addParam">Agregar Parametro</button>
    		<button type="button" class="showResults">Mostrar Resultados</button>
                <a href="gCosto.jsp">Volver a gráficos de costo</a>
    	</div>
    </form>
    <div id="grafico"></div>
    <script>
        ...
        function addParam(){
            ...
            let newHTML = '<div><input type="text" class="parametro" placeholder="Dia"><input type="time" class="valor" placeholder="Costo total"></div>'; 
