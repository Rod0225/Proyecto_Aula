<%-- 
    Document   : BusqNezahualcoyotl
    Created on : 6/06/2022, 10:32:54 PM
    Author     : luisc
--%>
...
<html>
    ...
    <body>
        ...
        <div class="rutas">
            <h1 class="rut">Ruta por metro Río de los Remedios</h1>
            <div id="mapa">
            <iframe src="https://www.google.com/maps/embed?pb=!1m28!1m12!1m3!1d60191.85745581194!2d-99.1499758660723!3d19.455950920262072!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m13!3e3!4m5!1s0x85d1fafb59b483ab%3A0x5fb778ae5601c55!2sR%C3%ADo%20de%20los%20Remedios%2C%20Avenida%20Carlos%20Hank%20Gonz%C3%A1lez%2C%20Valle%20de%20Aragon%202da%20Secci%C3%B3n%2C%20Nezahualc%C3%B3yotl%2C%20Estado%20de%20M%C3%A9xico!3m2!1d19.4906459!2d-99.04682539999999!4m5!1s0x85d1f8bd4ee71525%3A0x1ca0375a2453d0e1!2sPopotla%2C%20Ciudad%20de%20M%C3%A9xico%2C%20CDMX!3m2!1d19.453141799999997!2d-99.1802147!5e0!3m2!1ses-419!2smx!4v1654569884911!5m2!1ses-419!2smx" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>            
            <div class="container">
            ...
            <div id="transpor">
                <h3>Indicaciones</h3>
                <br/>
                <img src="/Ohrusoft/images/rio.jpg" width="550px" height="450px">
                <h3 class="indi">1. Tomar la línea B del metro</h3>
                <div id="metro">
                    <img src="/Ohrusoft/images/linea8.jpg" width="550px" height="450px">
                    <br/>
                    <h3 class="indi">2. Trasbordar línea 8 y bajar en Garibaldi</h3>
                    <img src="/Ohrusoft/images/metroCC.jpg" width="550px" height="450px">
                    <br/>
                    <h3 class="indi">3. Subir al metro línea 2 direccion tasqueña</h3>
                </div>                
            </div>            
        </div>
    </body>    
